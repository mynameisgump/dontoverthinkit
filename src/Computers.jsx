...
import { useVideoTexture, useTexture, Billboard, Image } from '@react-three/drei'
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <Billboard follow position={[-0.2, 2.5, 1.2]} scale={[1, 1, 1]} args={[1, 1]}>
        ...
        {/* <meshBasicMaterial toneMapped={false} map={billboardTexture} /> */}
        <Image url="/logo.png" scale={3.0} transparent />
      </Billboard>
    </group>
  )
}
...
function ScreenVideo({ invert, url, ...props }) {
