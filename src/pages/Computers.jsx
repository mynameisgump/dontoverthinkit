...
import { useVideoTexture, Billboard, Image, useGLTF, Merged, RenderTexture, PerspectiveCamera, Text } from "@react-three/drei";
...
License: CC-BY-4.0 (http://ceativecommons.org/licenses/by/4.0/)
...
export function Computers(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenText frame="Object_206" panel="Object_207" position={[0.27, 1.53, -2.61]} />
      ...
      <ScreenVideo url="./hacktheplanet.mp4" frame="Object_227" panel="Object_228" position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
      <ScreenText frame="Object_230" panel="Object_231" position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
      <Leds instances={instances} />
      <Billboard follow position={[-0.2, 2.5, 1.2]} scale={[1, 1, 1]} args={[1, 1]}>
        <Image url="./logo.png" scale={2.8} transparent />
      </Billboard>
      {/* <Button position={[-0.1, 0.2, 1]}>CONTACT</Button> */}
    </group>
  );
}
...
function Screen({ frame, panel, children, texture, ...props }) {
...
function ScreenText({ invert, x = 0, y = 1.2, ...props }) {
  ...
  return (
    <Screen {...props}>
      ...
      <color attach="background" args={[invert ? "white" : "#006633"]} />
      <ambientLight intensity={0.5} />
      <directionalLight position={[10, 10, 5]} />
      <Text font="./Plex.ttf" position={[x, y, 0]} ref={textRef} fontSize={4} letterSpacing={-0.1} color={!invert ? "white" : "#006633"}>
        MAY 17TH 2024
      </Text>
    </Screen>
  );
...
/* Renders a monitor with a video */
function ScreenVideo({ url, ...props }) {
  const texture = useVideoTexture(url);
  texture.matrixAutoUpdate = false;
  texture.matrix.setUvTransform(-2, -2.5, 5, 5, 0, 0, 0);
  return <Screen {...props} texture={texture} />;
}
